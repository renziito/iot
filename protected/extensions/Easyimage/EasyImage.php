...
Yii::import('application.extensions.Easyimage.drivers.Image');
Yii::import('application.extensions.Easyimage.drivers.Image_GD');
Yii::import('application.extensions.Easyimage.drivers.Image_Imagick');
